...
$resultgetgerentes = mysqli_query($db, $sqlgetgerentes);
?><div class="userslist"><?php
...
while($rowg = mysqli_fetch_assoc($resultgetgerentes)){
	echo "<div class='listitem'><div class='itempart'><a>" . $rowg['username'] . "</a></div><div class='itempart'><a>" . $rowg['title'] . "</a></div><div class='itempart'><a>Hotel: " . $rowg['code'] . "</a></div><div class='itempartright'>";
	?><a href='index.php?page=usuarios&deleteuser=<?php echo $rowg['id']; ?>'><?php echo "<span class='icon-remove'></span></a></div></div>";
}
}
?>
</div>
...
$resultgetcoorp = mysqli_query($db, $sqlgetcoorp);
?><div class="userslist"><?php
...
while($rowc = mysqli_fetch_assoc($resultgetcoorp)){
	echo "<div class='listitem'><div class='itempart'><a>" . $rowc['username'] . "</a></div><div class='itempart'><a>" . $rowc['title'] . "</a></div><div class='itempartright'>";
	?><a href='index.php?page=usuarios&deleteuser=<?php echo $rowc['id']; ?>'><?php echo "<span class='icon-remove'></span></a></div></div>";
}
...
$resultgetadmin = mysqli_query($db, $sqlgetadmin);
?><div class="userslist"><?php
...
while($rowa = mysqli_fetch_assoc($resultgetadmin)){
	...
	echo "<div class='listitem'><div class='itempart'><a>" . $rowa['username'] . "</a></div><div class='itempart'><a>" . $rowa['title'] . "</a></div><div class='itempartright'>";
	?><a href='index.php?page=usuarios&deleteuser=<?php echo $rowa['id']; ?>'><?php echo "<span class='icon-remove'></span></a></div></div>";
	}
	}
...
$resultgetdev = mysqli_query($db, $sqlgetdev);
?><div class="userslist"><?php
...
while($rowd = mysqli_fetch_assoc($resultgetdev)){
	...
	echo "<div class='listitem'><div class='itempart'><a>" . $rowd['username'] . "</a></div><div class='itempart'><a>" . $rowd['title'] . "</a></div><div class='itempartright'>";
	?><a href='index.php?page=usuarios&deleteuser=<?php echo $rowd['id']; ?>'><?php echo "<span class='icon-remove'></span></a></div></div>";
	}
	}
